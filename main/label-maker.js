...
function createCircularTextObject(object, bounds) {
    switch (object.Mode) {
        case 'ArcTextTop':
            fillTextCurve(object.Text, bounds.width / 4, Math.PI / 12, 1);
            break;
        case 'ArcTextBottom':
            fillTextCurve(object.Text, bounds.width / 4, Math.PI / 12);
            break;
        case 'CircularText':
 ...
 ******************************************************************************************/
function fillTextCurve(text, radius, space, top) {
    space = space || 0;
 ...
 *                                                Barcode Object                                                         *
 *************************************************************************************************************************/
function createBarcodeObject(bounds, i) {
    var img = new Image;
    img.onload = function () {
